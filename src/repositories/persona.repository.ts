...
> {
  ...
  constructor(
    @inject('datasources.pedidosEnHp') dataSource: PedidosEnHpDataSource, @repository.getter('PedidoRepository') protected pedidoRepositoryGetter: Getter<PedidoRepository>,
  ) {
